...
/**
 * Munkanaptár beállítás oldal — a korábbi WorkCalendarDialog tartalma.
 * A műszakadat-hiány ellenőrzés (Gyártás nézet) ezt használja, hogy
 * hétvégére/ünnepre ne adjon álriasztást.
 */
export default function MunkanaptarPage() {
  ...
  useEffect(() => {
    setDraft({ ...DEFAULT_WORK_CALENDAR, ...saved })
  }, [saved])
  ...
  return (
    <Card className="max-w-md">
      <CardHeader>
        <CardTitle>Munkanaptár</CardTitle>
        <CardDescription>
